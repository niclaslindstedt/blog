...
mentions:
  - type: highlight
    ...
    description: The live CV — a single block of structured data projected into a website, two PDFs, a link-preview image, and a version AI assistants can read.
    link: https://niclaslindstedt.se
  - type: mention
    title: cv (source code)
    description: The repository the site is built from, if you want to see how the data, the build, and the AI-editing rules fit together.
