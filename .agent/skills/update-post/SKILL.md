...
- [ ] `mentions:` preserved verbatim unless the edit changes which external references the panel should lift; refreshed (or added if missing) using `../write-post/SKILL.md` § "Authoring mentions"; at most one `highlight` per audience version
